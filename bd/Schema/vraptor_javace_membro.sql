CREATE DATABASE  IF NOT EXISTS `vraptor_javace` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `vraptor_javace`;
-- MySQL dump 10.13  Distrib 5.1.49, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: vraptor_javace
-- ------------------------------------------------------
...
-- Dump completed on 2011-08-25 16:35:46
